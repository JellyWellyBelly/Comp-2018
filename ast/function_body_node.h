// $Id: function_body_node.h,v 1.3 2018/03/23 16:28:33 ist426009 Exp $ -*- c++ -*-
...
namespace gr8 {
  ...
  public:
    inline function_body_node(int lineno, cdk::sequence_node *args, cdk::typed_node *return_type, gr8::block_node *block, std::string *fidentifier, Qualifier qualifier) :
